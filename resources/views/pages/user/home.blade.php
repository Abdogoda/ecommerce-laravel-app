...
<!-- Hero Section -->
    <section
      class="relative w-full flex items-center bg-cover bg-center overflow-hidden"
      style="
        min-height: 80vh;
        background-image:
          linear-gradient(
    ...
    >
      ...
      <div class="absolute inset-0 overflow-hidden">
        <div
          class="absolute top-20 left-10 w-4 h-4 bg-blue-400 rounded-full animate-bounce"
        ></div>
        <div
          class="absolute top-40 right-20 w-6 h-6 bg-purple-400 rounded-full animate-ping"
        ></div>
        <div
          class="absolute bottom-40 left-20 w-8 h-8 bg-pink-400 rounded-full animate-pulse"
        ></div>
        <div
          class="absolute bottom-20 right-10 w-3 h-3 bg-yellow-400 rounded-full animate-spin"
        ></div>
      </div>
      ...
      <div class="relative z-10 px-6 max-w-4xl mx-auto text-center">
        ...
        <p
          class="mt-4 text-xl md:text-2xl text-gray-200 mb-8 animate-fade-in-up delay-200"
        >
        ...
        <div
          class="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up delay-500"
        >
          <a
            href="products.html"
      ...
      <div class="max-w-7xl mx-auto">
        <div class="flex justify-between items-center mb-12">
          <h2 class="text-4xl font-bold text-white animate-fade-in-up">
            ...
            <div
              class="w-24 h-1 bg-gradient-to-r from-blue-400 to-purple-500 mt-4 rounded-full"
            ></div>
          </h2>
          <a
            href="../user/categories.html"
    ...
    <section class="py-16 px-6 bg-gray-900">
      <div class="max-w-7xl mx-auto">
        <h2
          class="text-4xl font-bold text-center mb-12 text-white animate-fade-in-up"
        >
          <span
    ...
    <section class="py-16 px-6 bg-gray-800">
      <div class="max-w-7xl mx-auto">
        ...
        >
          <span
            class="bg-gradient-to-r from-pink-400 to-orange-500 bg-clip-text text-transparent"
          >
            New Arrivals
          </span>
          <div
            class="w-24 h-1 bg-gradient-to-r from-pink-400 to-orange-500 mx-auto mt-4 rounded-full"
          ></div>
        </h2>
    ...
    <section class="py-16 px-6 bg-gray-900">
      <div class="max-w-7xl mx-auto">
        ...
        >
          ...
          <div
            class="w-24 h-1 bg-gradient-to-r from-cyan-400 to-blue-500 mx-auto mt-4 rounded-full"
          ></div>
        </h2>
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        ...
        // Intersection Observer for animations (already handled in common.js)
        // Smooth scrolling for anchor links (already handled in common.js)
      });
    </script>
@endsection
