...
<div class="max-w-6xl mx-auto">
        ...
        <!-- Tab Navigation -->
        <div
          class="flex flex-wrap justify-center gap-4 mb-8 animate-fade-in-up delay-200"
        >
          <button
        ...
        <div
          id="infoTab"
          class="order-tab-content animate-fade-in-up delay-300"
        >
          <div class="glass rounded-2xl p-8 shadow-2xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="space-y-4">
                ...
                >
                  ...
                  <span
                    class="px-3 py-1 bg-green-500 text-white rounded-full text-sm font-semibold"
                  >
            ...
            <div class="flex flex-wrap gap-4 mt-8 hidden">
              <button
                onclick="openModal('changeShippingAddressModal')"
              ...
              <button
                onclick="openModal('cancelOrderModal')"
        ...
        <div
          id="itemsTab"
          class="order-tab-content hidden animate-fade-in-up delay-400"
        >
          <div class="glass rounded-2xl p-8 shadow-2xl">
            <h3 class="text-2xl font-bold text-white mb-8 flex items-center">
            ...
            <div class="space-y-4">
              ...
              >
                <div class="flex items-center space-x-6">
                  <div class="flex-shrink-0">
                    <img
                      src="https://images.unsplash.com/photo-1527864550417-7fd91fc51a46?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80"
                      class="w-20 h-20 object-cover rounded-xl shadow-lg"
        ...
        <div
          id="statusesTab"
          class="order-tab-content hidden animate-fade-in-up delay-500"
        >
          <div class="glass rounded-2xl p-8 shadow-2xl">
            <h3 class="text-2xl font-bold text-white mb-8 flex items-center">
            ...
            <div class="relative">
              ...
              <div class="space-y-8">
                ...
                <div class="relative flex items-start">
                  ...
                  <div
                    class="ml-6 bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 flex-1"
                  >
