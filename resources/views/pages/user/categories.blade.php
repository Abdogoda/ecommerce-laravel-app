...
<div class="max-w-7xl mx-auto">
        ...
        <div class="text-center mb-16 animate-fade-in-up">
          ...
          <div
            class="w-32 h-1 bg-gradient-to-r from-blue-400 to-purple-500 mx-auto rounded-full mb-4"
          ></div>
        ...
        >
          ...
          <div class="group animate-fade-in-up delay-100">
            ...
            >
              ...
              <div
                class="mt-4 text-blue-400 group-hover:text-blue-300 transition-colors duration-300"
              >
          ...
          <div class="group animate-fade-in-up delay-200">
            <a
              href="category.html?category=clothing"
            ...
            >
              <div
                class="w-24 h-24 bg-gradient-to-br from-purple-400 to-purple-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:rotate-12 transition-transform duration-300 animate-float"
              ...
              <div
                class="mt-4 text-purple-400 group-hover:text-purple-300 transition-colors duration-300"
              >
                <i class="fas fa-arrow-right"></i>
              </div>
            </a>
          ...
          <div class="group animate-fade-in-up delay-300">
            <a
              href="category.html?category=books"
            ...
            >
              <div
                class="w-24 h-24 bg-gradient-to-br from-green-400 to-green-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:rotate-12 transition-transform duration-300 animate-float"
              ...
              <div
                class="mt-4 text-green-400 group-hover:text-green-300 transition-colors duration-300"
              >
                <i class="fas fa-arrow-right"></i>
              </div>
            </a>
          ...
          <div class="group animate-fade-in-up delay-400">
            <a
              href="category.html?category=home"
            ...
            >
              <div
                class="w-24 h-24 bg-gradient-to-br from-orange-400 to-orange-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:rotate-12 transition-transform duration-300 animate-float"
              ...
              <div
                class="mt-4 text-orange-400 group-hover:text-orange-300 transition-colors duration-300"
              >
                <i class="fas fa-arrow-right"></i>
              </div>
            </a>
          ...
          <div class="group animate-fade-in-up delay-500">
            ...
            >
              <div
                class="w-24 h-24 bg-gradient-to-br from-red-400 to-red-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:rotate-12 transition-transform duration-300 animate-float"
              ...
              <div
                class="mt-4 text-red-400 group-hover:text-red-300 transition-colors duration-300"
              >
                <i class="fas fa-arrow-right"></i>
              </div>
            </a>
          ...
          <div class="group animate-fade-in-up delay-600">
            <a
              href="category.html?category=beauty"
            ...
            >
              <div
                class="w-24 h-24 bg-gradient-to-br from-pink-400 to-pink-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:rotate-12 transition-transform duration-300 animate-float"
              ...
              <div
                class="mt-4 text-pink-400 group-hover:text-pink-300 transition-colors duration-300"
              >
                <i class="fas fa-arrow-right"></i>
              </div>
            </a>
          ...
          <div class="group animate-fade-in-up delay-700">
            <a
              href="category.html?category=automotive"
            ...
            >
              <div
                class="w-24 h-24 bg-gradient-to-br from-indigo-400 to-indigo-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:rotate-12 transition-transform duration-300 animate-float"
              ...
              <div
                class="mt-4 text-indigo-400 group-hover:text-indigo-300 transition-colors duration-300"
              >
                <i class="fas fa-arrow-right"></i>
              </div>
            </a>
          ...
          <div class="group animate-fade-in-up delay-800">
            <a
              href="category.html?category=toys"
            ...
            >
              <div
                class="w-24 h-24 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:rotate-12 transition-transform duration-300 animate-float"
              ...
              <div
                class="mt-4 text-yellow-400 group-hover:text-yellow-300 transition-colors duration-300"
              >
                <i class="fas fa-arrow-right"></i>
              </div>
            </a>
