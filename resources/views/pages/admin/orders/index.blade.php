    ...
    <div class="admin-card rounded-xl overflow-hidden">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full">
                ...
                <tbody id="ordersTableBody">
                    <tr class="border-b border-white/5 hover:bg-white/5 transition-colors" data-order-id="1">
                        ...
                        <td class="py-4 px-6">
                            <div class="flex items-center">
                                <div>
                                    <a href="../profile.html"
                                        class="text-white hover:text-blue-400 transition-colors font-medium">John Doe</a>
                    ...
                    <tr class="border-b border-white/5 hover:bg-white/5 transition-colors" data-order-id="2">
                        <td class="py-4 px-6 text-nowrap">
                            <a href="./show.html"
                                class="flex items-center text-white hover:text-purple-400 transition-colors">
                                <div
                        ...
                        <td class="py-4 px-6">
                            <div class="flex items-center">
                                <div>
                                    <a href="../profile.html"
                                        class="text-white hover:text-blue-400 transition-colors font-medium">Jane Smith</a>
                    ...
                    <tr class="border-b border-white/5 hover:bg-white/5 transition-colors" data-order-id="3">
                        <td class="py-4 px-6 text-nowrap">
                            <a href="./show.html"
                                class="flex items-center text-white hover:text-purple-400 transition-colors">
                                <div
                        ...
                        <td class="py-4 px-6">
                            <div class="flex items-center">
                                <div>
                                    <a href="../profile.html"
                                        class="text-white hover:text-blue-400 transition-colors font-medium">Mike
                                        Johnson</a>
                    ...
                    <tr class="border-b border-white/5 hover:bg-white/5 transition-colors" data-order-id="4">
                        <td class="py-4 px-6 text-nowrap">
                            <a href="./show.html"
                                class="flex items-center text-white hover:text-purple-400 transition-colors">
                                <div
                        ...
                        <td class="py-4 px-6">
                            <div class="flex items-center">
                                <div>
                                    <a href="../profile.html"
                                        class="text-white hover:text-blue-400 transition-colors font-medium">Sarah
                                        Wilson</a>
                    ...
                    <tr class="border-b border-white/5 hover:bg-white/5 transition-colors" data-order-id="5">
                        <td class="py-4 px-6 text-nowrap">
                            <a href="./show.html"
                                class="flex items-center text-white hover:text-purple-400 transition-colors">
                                <div
                        ...
                        <td class="py-4 px-6">
                            <div class="flex items-center">
                                <div>
                                    <a href="../profile.html"
                                        class="text-white hover:text-blue-400 transition-colors font-medium">David
                                        Brown</a>
        ...
        <div class="p-4 border-t border-white/10 flex items-center justify-between">
            <div class="flex items-center space-x-4">
                ...
                <select class="glass bg-white/5 text-white border-0 rounded-lg px-3 py-1 text-sm">
            ...
            <div class="flex items-center space-x-2">
                <button class="glass px-3 py-1 rounded-lg text-gray-400 hover:text-white disabled:opacity-50" disabled>
                    <i class="fas fa-chevron-left"></i>
                </button>
                <span class="glass px-3 py-1 rounded-lg text-white">1</span>
                <button class="glass px-3 py-1 rounded-lg text-gray-400 hover:text-white">
                    2
                </button>
                <button class="glass px-3 py-1 rounded-lg text-gray-400 hover:text-white">
                    3
