...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
  ...
  <!-- Total Products -->
  <div
    class="admin-card stat-card p-6 rounded-2xl animate-slide-in"
  ...
  >
    ...
    <div class="mt-4 bg-gray-700/30 rounded-full h-2">
      <div
        class="progress-bar bg-emerald-500 h-2 rounded-full"
        style="width: 65%"
      ></div>
    </div>
  </div>
  ...
  >
    ...
    <div class="mt-4 bg-gray-700/30 rounded-full h-2">
      <div
        class="progress-bar bg-purple-500 h-2 rounded-full"
        style="width: 85%"
      ></div>
    </div>
  </div>
  ...
  >
    ...
    <div class="mt-4 bg-gray-700/30 rounded-full h-2">
      <div
        class="progress-bar bg-amber-500 h-2 rounded-full"
        style="width: 90%"
      ></div>
    </div>
  </div>
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
  ...
  <!-- Verified Users -->
  <div
    class="admin-card p-6 rounded-2xl animate-fade-in"
    style="animation-delay: 0.1s"
  >
    <div class="flex items-center justify-between mb-4">
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
  ...
  <div class="admin-card p-6 rounded-2xl animate-bounce-in">
    <div class="flex items-center justify-between mb-6">
      ...
      <div class="flex space-x-2">
        ...
        <button
          class="text-blue-400 text-sm px-3 py-1 rounded-lg bg-blue-500/20"
        >
          Year
        </button>
      </div>
  ...
  <div
    class="admin-card p-6 rounded-2xl animate-bounce-in"
    style="animation-delay: 0.1s"
  >
    <div class="flex items-center justify-between mb-6">
