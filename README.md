...
- Follow PSR-12 coding standards (enforced via Pint)
...
- [Laravel Settings](https://spatie.be/docs/laravel-settings)
- [Laravel Translatable](https://spatie.be/docs/laravel-translatable)
- [Laravel Sluggable](https://spatie.be/docs/laravel-sluggable)
